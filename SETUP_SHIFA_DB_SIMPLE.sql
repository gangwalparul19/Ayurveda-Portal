-- =====================================================
-- SIMPLE SHIFA DATABASE SETUP
-- No tenants, just one database for Shifa
-- =====================================================

-- Step 1: Create Shifa database
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    order_source        ENUM('WHATSAPP', 'MANUAL', 'STOREFRONT', 'API') NOT NULL DEFAULT 'STOREFRONT',
...
SELECT CONCAT('Products added: ', COUNT(*)) as Result FROM products;

-- =====================================================
-- DONE! Now:
-- 1. Make sure application.yml has: active: simple
-- 2. Restart backend
-- 3. Open http://localhost:4200/store
-- =====================================================
